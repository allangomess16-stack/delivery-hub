...
describe("resolverTelaInicial", () => {
  ...
  it("separa suporte da administracao", () => expect(resolverTelaInicial({ usuarioId: "s", email: "s@s", nome: "Suporte", tipo: "SUPORTE" })).toBe("SUPORTE_INTEGRACOES"));
  ...
  it("envia entregador vinculado para o lobby", () => expect(resolverTelaInicial({ usuarioId: "3", email: "e@e", nome: "Entrega", tipo: "ENTREGADOR", entregadorId: "ENT-1" })).toBe("ENTREGADOR_LOBBY"));
});
