...
describe("particionarCargaPorPerfil", () => {
  ...
  it("nao publica carga vazia para uma coluna sem trackings", () => {
    const semPacotes: CargaImportada = { ...carga, pacotes: [] };
    expect(particionarCargaPorPerfil(semPacotes, encontrados, "2026-08-29")).toEqual([]);
  });
});
