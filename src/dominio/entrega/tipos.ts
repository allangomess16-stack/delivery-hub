...
/** Campos observados no fluxo real da iMile 2.3.21. */
export type TipoRecebedorImile =
  | "PROPRIO"
  | "PORTARIA"
  | "OUTROS"
  | "FUNCIONARIO"
...
export type TipoDocumentoImile = "CPF" | "RG" | "CNH" | "PASSAPORTE" | "OUTRO";

/**
 * Prova preparada no Hub para digitacao assistida na iMile. Nenhum destes
 * dados afirma que a baixa externa foi confirmada.
 */
export interface DadosComprovacaoImile {
  recebedor: TipoRecebedorImile;
  nomeCompleto: string;
  tipoDocumento: TipoDocumentoImile;
...
export interface EstadoEntrega {
  ...
  dadosComprovacaoImile?: DadosComprovacaoImile;
