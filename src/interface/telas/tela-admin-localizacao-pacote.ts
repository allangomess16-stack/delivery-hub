  ...
  return `
    ...
    <main class="conteudo conteudo--com-rodape">
      <section class="cabecalho-etapa">
        ...
        <h1>${escaparHtml(pacote.codigoNormalizado)}</h1>
        <p>O endereco ajuda o sistema a agrupar a carga. A regiao pode ser detectada automaticamente ou corrigida manualmente.</p>
      </section>
