...
export class AutenticacaoLocalAdapter implements ServicoAutenticacao {
  ...
  async solicitarRedefinicaoSenha(_email: string): Promise<void> {
    throw new Error("O servidor local nao envia email. Use o modo Firebase para enviar a redefinicao de senha.");
  }
